...
export default function Compiler({ filterOption, setFilterOption }) {
  ...
  useEffect(() => {
    var dna = require('/public/uploads/sample/sample-dna.json');
    ...
    <div className="min-w-0 flex px-4 sm:px-6 lg:px-8 mt-4">
      <div className="flex-1">
        ...
        <p class="text-sm font-medium leading-6 text-gray-500">
          This is a random sample report. Real reports are much longer and contain more types of information.
        </p>
      </div>
